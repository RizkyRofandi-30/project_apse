...
<head>
    ...
    <title>Healthy Gate Container</title>
    ...
    <div class="max-w-2xl w-full">
        <div class="glass rounded-2xl p-10 shadow-2xl border border-white/10">
            <div class="flex items-center gap-4">
                ...
                <!-- Teks utama -->
                <div>
                    <h1 class="text-4xl sm:text-5xl font-bold tracking-tight text-white leading-tight">healthy gate</h1>
        ...
        <!-- Footer kecil -->
        <p class="mt-6 text-center text-xs text-white/50">© <span id="year"></span> healthy gate</p>
    </div>
